...
def tabela(int_arquivo): # {=========Informações da tabela(FRAME 2)=========}
    ...
    print('\narquivo =',int_arquivo )
    conn, cursor = fun.CONECTA_BD(r"C:\Users\20221CECA0402\Documents\Projeto_WRL\Aplicativo_WRL\REGISTROS_WRL.db")
...
def imagens(registro_foto):  # {=========Informações para imagens(FRAME 2)=========}
    ...
    endereco_pastafotos = r"C:\Users\20221CECA0402\Documents\Projeto_WRL\Aplicativo_WRL\fotos_BW"
    endereco_pastaguias = r"C:\Users\20221CECA0402\Documents\Projeto_WRL\Aplicativo_WRL\fotos_segmentada"
